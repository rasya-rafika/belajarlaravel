    ...
    <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <form class="space-y-3">
            ...
            <input type="text" placeholder="Name"
                class="w-full pl-10 p-2 rounded border border-gray-300 bg-white text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#FF8750] transition" />
            </div>
            <div class="relative">
            ...
            <textarea placeholder="Message" rows="3"
                class="w-full pl-10 p-2 rounded border border-gray-300 bg-white text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#FF8750] transition"></textarea>
            </div>
            <button class="bg-red-600 text-white px-5 py-2 rounded hover:bg-red-700 transition font-semibold">Send</button>
        </form>
        </div>
